...
class FlowersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flower" do
    assert_difference('Flower.count') do
      post flowers_url, params: { flower: { description: @flower.description, name: @flower.name, picture: @flower.picture } }
    end
  ...
  test "should update flower" do
    patch flower_url(@flower), params: { flower: { description: @flower.description, name: @flower.name, picture: @flower.picture } }
